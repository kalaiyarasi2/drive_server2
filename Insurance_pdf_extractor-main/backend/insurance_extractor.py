...
{{
  ...
  "claims": [
    {{
      ...
      "claim_class": "STRICTLY NUMERIC class code ONLY (e.g. 340, 882707). NO letters. Correct OCR typos (e.g. 34p -> 340). Null if valid number is missing",
...
{{
  ...
  "body_part": "body part or null",
  "injury_type": "Indemnity or Medical Only or Expense",
  "claim_class": "STRICTLY NUMERIC class code ONLY (e.g. 340). NO letters. Correct typos. Null if missing",
